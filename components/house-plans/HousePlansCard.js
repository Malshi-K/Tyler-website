  ...
  const roomsData = [
    {
      ...
      description: "This large, luxury family home features a central courtyard and a beautifully appointed chef's kitchen for entertaining and extended Family gatherings. Outdoor living can be accessed via the master bedroom as well as from all three spacious, open plan living areas",
      features: [
        {
    ...
    },
    {
      ...
      description: "If you love entertaining, check out Matai. The front entrance welcomes family and friends into a well-appointed layout. The kitchen is a good host's delight, with separate scullery, and there's an area for alfresco dining plus a formal lounge. Your guest room has a semi-ensuite.",
      features: [
        {
          icon: <BedSingle className="w-5 h-5 text-navy" />,
          text: "4 Bedrooms"
    ...
    },
    {
      ...
      description: "If you seek space, Kauri is perfect. At over 360 square metres, you have a separate formal living room, separate guest wing, and a garage workshop that could be used as an office. Outside, there's a stunning entertaining area, framed by schist-clad columns and exposed gable beams.",
      features: [
        {
          icon: <BedSingle className="w-5 h-5 text-navy" />,
          text: "4 Bedrooms"
    ...
    },
    {
      ...
      description: "If you enjoy good company, this home is an entertainer's dream. Stacked rooflines draw attention to the welcoming foyer. Inside, the expansive living area allows multiple options to dress and use the space to reflect your personality",
      features: [
        {
          icon: <BedSingle className="w-5 h-5 text-navy" />,
          text: "4 Bedrooms"
    ...
    },
    {
      ...
      description: "Designed for visual impact, this split-level home combines striking mid-century modern lines with a spacious, contemporary layout. With three bedrooms and a large, open plan living area on the upper level and a garage and study below, it would be ideal for a home-based business.",
      features: [
        {
          icon: <BedSingle className="w-5 h-5 text-navy" />,
          text: "3 Bedrooms"
